...
// --- NAVİQASİYA SİSTEMİ ---
// DİQQƏT: 'param' parametri əlavə edildi (ID ötürmək üçün)
function navigateTo(pageId, param = null) {
    
    // 1. Mobil Menyu Düzəlişi
    ...
    if (pageId === 'project-details' && param) {
        if (typeof window.renderProjectDetailsPage === 'function') {
            ...
            console.error("renderProjectDetailsPage funksiyası tapılmadı. js/pages/project-details.js faylını yoxlayın.");
        }
        return;
    }

    // --- [YENİ] LAYİHƏLƏR SİYAHISI (Dinamik Render) ---
    if (pageId === 'projects') {
...
// navigateTo daxilində statik yoxlamadan əvvəl bunu əlavə et:
